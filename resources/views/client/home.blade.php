            ...
            <div class="row">
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card">
                        ...
                        <div class="card-body">
                            <h3 class="h4 mb-3"><a class="post-title" href="post-details.html">Tiêu đề</a></h3>
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <aside class="col-lg-4 sidebar-home">
                    ...
                    <div class="widget">
                        <h4 class="widget-title">Bài viết bạn đọc gần đây</h4>
                    ...
                    <!-- Social -->
                    <div class="widget">
                        <h4 class="widget-title"><span>Các trang mạng xã hội</span></h4>
