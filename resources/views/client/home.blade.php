            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    ...
                    <ul class="list-inline widget-list-inline">
                        <li class="list-inline-item"><a href="{{ route('list') }}">Thành phố</a></li>
                        <li class="list-inline-item"><a href="tags.html">Màu</a></li>
                        <li class="list-inline-item"><a href="tags.html">Màu</a></li>
                        <li class="list-inline-item"><a href="tags.html">Màu</a></li>
                        <li class="list-inline-item"><a href="tags.html">Màu</a></li>
                        <li class="list-inline-item"><a href="tags.html">Màu</a></li>
                ...
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card">
                        <div class="post-slider slider-sm">
                            <img src="/uploads/post/{{ $postEdittor->thumbnail }}" class="card-img-top" alt="post-thumb">
                        </div>

                        <div class="card-body">
                            <h3 class="h4 mb-3"><a class="post-title" href="post-details.html">{{ $postEdittor->title }}</a></h3>
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="images/john-doe.jpg">
                                        <span>Le Duy Linh</span>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <i class="ti-calendar"></i>{{ $postEdittor->created_at }}
                                </li>
                                <li class="list-inline-item">
                                    <ul class="card-meta-tag list-inline">
                                        <li class="list-inline-item"><a href="#">Thời tiết</a></li>
                                    </ul>
                                </li>
                            </ul>
                            <p>Mô tả</p>
                            <a href="{{ route('detail',$postEdittor->id) }}" class="btn btn-outline-primary">Đọc thêm</a>
                        </div>
                    </article>
                </div>
                <div class="col-lg-4 mb-5">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8  mb-5 mb-lg-0">
                    <h2 class="h5 section-title">Bài viết bạn đọc gần đây</h2>
                    <article class="card mb-4">
