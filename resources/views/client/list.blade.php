        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8  mb-5 mb-lg-0">
                    <h1 class="h2 mb-4">Các bài viết có thẻ <mark>{{ $tagName->name }}</mark></h1>
                    @if ($posts->isNotEmpty())
                        @foreach ($posts as $post)
                            <article class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('detail', $post->slug) }}" class="btn btn-outline-primary">Đọc thêm</a>
                                </div>
                            </article>
                        @endforeach
                    @else
                        <p>Không có bài viết nào chứa thẻ này</p>
                    @endif
                </div>
