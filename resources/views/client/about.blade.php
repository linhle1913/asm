            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-5 col-md-6 mb-4 mb-md-0">
                    <div class="image-wrapper">
                        <img class="img-fluid w-100" src="images/about-me.jpg">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6">
                    <div class="content pl-lg-3 pl-0">
                        <h2 id="helllo-im-richi-andorn-im-a-biography-based-researcher-and-author">Helllo I’m Richi Andorn
                            I’m a Biography Based researcher And Author</h2>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-5 col-md-6 order-2 order-md-1 text-center text-md-left">
                    <h2 class="mb-4">Don’t forget to subscribe my Youtube channel “Richi Andorn”</h2>
                    <a href="https://www.youtube.com/channel/UCx9qVW8VF0LmTi4OF2F8YdA" class="btn btn-primary">Visit
                        Channel</a>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="card border-0 rounded-0 text-center shadow-none overflow-hidden">
                        <a href="#!">
                            <div class="book-cover">
                                <img src="images/books/01.jpg" alt="" class="card-img-top rounded-0">
                            </div>
                            <div class="card-body">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card border-0 rounded-0 text-center shadow-none overflow-hidden">
                        <a href="#!">
                            <div class="book-cover">
                                <img src="images/books/02.jpg" alt="" class="card-img-top rounded-0">
                            </div>
                            <div class="card-body">
                                <h4 class="text-uppercase mb-3">Book of Earth</h4>
                                <p class="h4">$25.00</p>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card border-0 rounded-0 text-center shadow-none overflow-hidden">
                        <a href="#!">
                            <div class="book-cover">
                                <img src="images/books/03.jpg" alt="" class="card-img-top rounded-0">
                            </div>
                            <div class="card-body">
                                <h4 class="text-uppercase mb-3">Book of Earth</h4>
                                <p class="h4">$25.00</p>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card border-0 rounded-0 text-center shadow-none overflow-hidden">
                        <a href="#!">
                            <div class="book-cover">
                                <img src="images/books/04.jpg" alt="" class="card-img-top rounded-0">
                            </div>
                            <div class="card-body">
                                <h4 class="text-uppercase mb-3">Book of Earth</h4>
                                <p class="h4">$25.00</p>
