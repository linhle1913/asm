                        ...
                        <div class="card border border-light-subtle rounded-4">
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-5">
                                            <h4 class="text-center">Đăng kí tại đây</h4>
                                        </div>
                                    </div>
                                </div>
                                <form action="{{ Route('account.processRegister') }}" method="POST">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn bsb-btn-xl btn-primary py-3" type="submit">Đăng kí</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                            <a href="{{ Route('account.login') }}" class="link-secondary text-decoration-none">Nhấn đây để đăng nhập</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
